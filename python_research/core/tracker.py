...
class MediaPipePoseTracker:
    def __init__(self, model_path='pose_landmarker_full.task'):
        # Configuramos MediaPipe Tasks de forma robusta
        ...
        # Mapeo de los 33 landmarks tradicionales a nombres legibles
        self.lm_mapping = {
            'nose': 0,
    ...
    def process_frame(self, image_rgb):
        """
        Procesa una imagen RGB y devuelve un PoseResult object con coordenadas escaladas.
        """
        ...
        if detection_result.pose_landmarks:
            ...
            for name, idx in self.lm_mapping.items():
                # Refuerzo de Seguridad: Z-negativo indica 'hacia la cámara'.
    ...
    def mp_pose_pose_draw(self, results, image):
        # Stub para compatibilidad con la firma de dibujo legacy.
        pass
